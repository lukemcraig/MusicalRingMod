...
AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
{
    ...
    std::function<String(float value, int maximumStringLength)> lfoFreqValueToHzFunction = [
    ...
    std::function<String(float value, int maximumStringLength)> octaveValueToText = [
        ](float value, int maximumStringLength)
    {
    ...
    std::function<String(float value, int maximumStringLength)> semitonesValueToText = [
        ](float value, int maximumStringLength)
    {
    ...
    std::function<String(float value, int maximumStringLength)> centsValueToText = [
        ](float value, int maximumStringLength)
    {
    ...
    std::function<String(float value, int maximumStringLength)> depthValueToText = [
        ](float value, int maximumStringLength)
    {
        return String(value * 100.0f, 2) + String("%");
    };
    std::function<float(const String& text)> depthTextToValue = [](const String& text)
    {
    ...
    std::function<String(float value, int maximumStringLength)> sourceValueToText = [
        ](float value, int maximumStringLength)
    {
        return value < 0.5 ? "Midi" : "Slider";
    };
    std::function<float(const String& text)> sourceTextToValue = [](const String& text)
    {
    ...
    std::function<String(float value, int maximumStringLength)> pitchValueToText = [
        ](float value, int maximumStringLength)
    {
...
float MusicalRingModAudioProcessor::convertMidiToHz(const float noteNumber, const float semiToneOffset,
                                                    const float a4) const
{
